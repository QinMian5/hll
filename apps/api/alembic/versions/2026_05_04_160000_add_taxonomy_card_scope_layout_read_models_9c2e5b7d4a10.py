"""add_taxonomy_card_scope_layout_read_models

Revision ID: 9c2e5b7d4a10
Revises: 77df962193b0
Create Date: 2026-05-04 16:30:11.759085
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id", name=op.f("pk_taxonomy_card_scope_layout_compute_requests")),
        sa.UniqueConstraint(
            "scope_kind",
            "taxonomy_node_id",
            "layout_version",
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index("ix_taxonomy_card_scope_layouts_scope", table_name="taxonomy_card_scope_layouts")
    op.drop_index(
        "ix_taxonomy_card_scope_layouts_input_fingerprint", table_name="taxonomy_card_scope_layouts"
    )
