...
class TaxonomyViewRedisCache:
    ...
    async def get_card_scope_layout(
        ...
        *,
        ...
        raw_payload = await self._redis.get(
            _card_scope_layout_key(
        ...
        try:
            payload = json.loads(payload_text)
            return TaxonomyCardScopeLayoutReadModel.model_validate(payload)
    ...
    async def set_card_scope_layout(
        ...
        *,
        ...
        read_model = TaxonomyCardScopeLayoutReadModel(
