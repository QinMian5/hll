...
export function Textarea({ className, ...props }: TextareaProps) {
  return (
    <textarea
      className={cn(
        "flex w-full min-w-0 resize-none overflow-hidden border-none bg-transparent text-knowledge-search-input text-knowledge-text-default outline-none [field-sizing:content] placeholder:text-knowledge-text-muted read-only:cursor-text read-only:text-knowledge-text-default disabled:cursor-not-allowed disabled:opacity-100",
        className,
      )}
      {...props}
    />
