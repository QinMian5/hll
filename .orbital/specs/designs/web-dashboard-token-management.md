...
- **Checks:**
  ...
  - Frontend tests cover dashboard loading, empty state, token table rendering, mobile row rendering, create dialog, rename dialog, delete confirmation, copy control behavior, authenticated error handling, and account-menu navigation.
