...
- **Key Elements:**
  ...
  - **Default tuning profile:** The lab default parameter profile is an Obsidian-like large-graph starting point for `science/physics/heat/thermodynamics`: `seed_base_radius=18`, `seed_radius_step=36`, `simulation_ticks=40`, `velocity_retention=0.5`, `link_base_distance=96`, `link_distance_strength_factor=70`, `link_base_strength=1.04`, `link_strength_factor=0.38`, `charge_strength=-70`, `collision_radius=12`, `collision_strength=0.9`, `center_gravity_strength=0.09`, `radial_boundary_radius=1250`, and `radial_boundary_strength=0.18`. The profile is a lab default only; promotion into production layout parameters requires a separate production layout-version change.
