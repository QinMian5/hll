...
- **Checks:**
  ...
  - Search result cards expose the approved hover/focus presentation with lift, scale, blue border emphasis, stronger elevation, top-right arrow affordance, and sibling cards dimmed to approximately `80%` opacity.
