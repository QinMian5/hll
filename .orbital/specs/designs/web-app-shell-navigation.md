...
- **Key Elements:**
  ...
  - **Graph View route:** `Graph View` renders the taxonomy browsing experience inside the shared shell body. Desktop uses the approved `320px` sidebar plus `1120px x 1024px` Graph View content slot. Mobile uses the approved `64px` header plus `440px x 892px` Graph View content slot. Graph-specific renderer and layout rules remain governed by taxonomy design documents.
