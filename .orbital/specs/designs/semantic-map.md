...
- **Reason:** Product interaction switched from semantic-space pan/zoom browsing to taxonomy-query-driven drill-down with React Flow. Legacy semantic-map rebuild, snapshot, tile contracts, and persistence are no longer active truth.
