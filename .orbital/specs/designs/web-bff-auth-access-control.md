...
- **Outputs:**
  ...
  - Browser-visible web data endpoints for Graph View, Search, authenticated Search card suggestion submission, and Dashboard token management.
