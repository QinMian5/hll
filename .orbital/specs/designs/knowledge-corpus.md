...
- **Source-pipeline separation:** Project-owned source-processing orchestration remains outside this app boundary. Source reading, source-side processed bookkeeping, queue interaction, step contracts, and orchestration state do not move into `apps/knowledge_corpus`.
