...
- **Interactions:**
  ...
  - Crossing deck orthographic viewport zoom `0.85` computes the active viewport plus overscan set from the throttled viewport snapshot and hydrates titles only for returned layout-slice nodes in that region.
