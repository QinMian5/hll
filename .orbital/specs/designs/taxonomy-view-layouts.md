...
- **Key Elements:**
  ...
  - **Leaf layer rule:** Leaf edges render in a non-interactive base line layer, overview points render in a scatter layer, and hydrated cards render in a text-backed card layer above the edges.
...
- **Checks:**
  ...
  - Leaf view uses deck.gl scene primitives for point, edge, and card rendering.
